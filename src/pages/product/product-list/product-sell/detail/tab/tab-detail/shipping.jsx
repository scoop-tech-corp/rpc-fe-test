...
const Shipping = () => {
  ...
  useEffect(() => {
    setShipping((value) => {
      return {
        ...value,
        isShipped: productSellDetail.isShipped,
        weight: productSellDetail.weight || '',
        length: productSellDetail.length || '',
        width: productSellDetail.width || '',
        height: productSellDetail.height || ''
      };
    });
  }, [productSellDetail]);
